namespace Binance.Spot.Tests
{
    ...
    {
        private string apiKey = "QtGKN6mzvVe0GANXdhjKifIFz1s4XgnxTZmy7aaHLGTeeErjQ5UraZFcFJFWoz7s";
        private string apiSecret = "0kTbtAwRq03ZXQC2HmO2uTmOqa6aTG2UAiDi9635sZbGvqCHKTRve1SHJDCs12uN";
        ...
        public async void SymbolPriceTicker_Response()
        {
            ...
            var result = await market.SymbolPriceTicker("BTCUSDT");
